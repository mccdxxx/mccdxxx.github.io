...
arg_id: P7-16-LETTER-AMY
phase: 7
order: 16
log_number: '7.16'
record_type: POST-RETURN MESSAGE
signal_strength: 0.0008%
requires:
- true-ending
timestamp: POST-RETURN // MESSAGE 08
sitemap: false
...
It used Amy's chosen name and nothing else from the dossier header.

> **TO JONATHAN, STEPHANIE E., JASON W., AMY M., SHADOW, AND SCOUT**

Amy M. gave me the card with my name. I still have it. It is such a stupid little thing,
which is probably why it matters. Tell her I stopped thinking of her as the other Amy before we left.
I hope she did too. If the archive ever starts writing just AMY again, fix it. Not because confusion
is dangerous. Because names are one of the first things a system decides it can simplify.

The Character Bible describes Amy through a role—**Mako's biological little sister; domestic grounding**—and a
trait structure that includes bright , observant , independent , affectionate , curious , practical , stubborn , expressive , perceptive , playful.

The letter does not reject those descriptions.

It rejects their sufficiency.

One line in the writer-facing material says that Amy wants to **have room to grow without everyone pre-solving her life**.
Another says they need to **be allowed to make age-appropriate mistakes**.
