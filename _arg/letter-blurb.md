...
requires:
- true-ending
timestamp: POST-RETURN // MESSAGE 12
sitemap: false
...
- phase-7
- letter
prev_slug: letter-zucchi
next_slug: letter-joel
---
...
It used Blurb's chosen name and nothing else from the dossier header.

> **TO JONATHAN, STEPHANIE E., JASON W., AMY M., SHADOW, AND SCOUT**

History does not give anyone lifetime access. I knew that before, apparently, because it
was in the bible. Knowing a principle and feeling it under pressure are different things. Mako and I
had years of shorthand you never wrote, Jonathan. I still had to learn that even old shorthand can
expire. Do not make familiarity proof that a boundary is unnecessary.

The Character Bible describes Blurb through a role—**Mako's cousin; family familiarity inside friend group**—and a
trait structure that includes familiar , teasing , loyal , casual , observant , stubborn , protective , funny , blunt , adaptable.

The letter does not reject those descriptions.

It rejects their sufficiency.

One line in the writer-facing material says that Blurb wants to **keep family closeness from becoming entitlement**.
Another says they need to **respect changed boundaries even when history is long**.
