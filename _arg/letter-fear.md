...
requires:
- true-ending
timestamp: POST-RETURN // MESSAGE 10
sitemap: false
...
It used Fear's chosen name and nothing else from the dossier header.

> **TO JONATHAN, STEPHANIE E., JASON W., AMY M., SHADOW, AND SCOUT**

Tell Stephanie E. thank you for sitting there without explaining me. That sounds small.
It was not. People think respecting somebody means having the perfect response. Sometimes it means
letting them own the response. Keep the guardrail in the bible. I still hate that it has to exist.
Both things remain true.

The Character Bible describes Fear through a role—**close friend; autistic character whose autism is one facet, not her entire plot**—and a
trait structure that includes direct , loyal , perceptive , enthusiastic , particular , funny , focused , independent , emotionally sincere , stubborn.

The letter does not reject those descriptions.

It rejects their sufficiency.

One line in the writer-facing material says that Fear wants to **participate without being treated as fragile or symbolic**.
Another says they need to **have preferences respected without others narrating them for her**.
