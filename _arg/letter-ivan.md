...
requires:
- true-ending
timestamp: POST-RETURN // MESSAGE 06
sitemap: false
...
- phase-7
- letter
prev_slug: letter-scarf
next_slug: letter-markov
---
...
It used Ivan's chosen name and nothing else from the dossier header.

> **TO JONATHAN, STEPHANIE E., JASON W., AMY M., SHADOW, AND SCOUT**

I am not writing a thank-you letter. I do not owe gratitude for being watched, separated,
or treated like the worst thing I did might happen again. You do not owe me trust either. Both can
be true. The worst part of the real world was discovering that leaving the story did not erase what
I had done. The best part may have been discovering it also did not force me to remain only that
incident. Do not call this redemption. I did not ask for that word.

The Character Bible describes Ivan through a role—**source of the gun incident and lasting safety rupture**—and a
trait structure that includes volatile , defensive , reckless , controlling , unpredictable , resentful , argumentative , strategic when cornered ,.

The letter does not reject those descriptions.

It rejects their sufficiency.

One line in the writer-facing material says that Ivan wants to **avoid consequences and retain control of the story around his actions**.
Another says they need to **face accountability rather than treating explanation as absolution**.
