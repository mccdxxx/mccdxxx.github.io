...
requires:
- true-ending
timestamp: POST-RETURN // MESSAGE 20
sitemap: false
...
- phase-7
- letter
prev_slug: letter-polar
next_slug: letter-raine
---
...
It used Redsky's chosen name and nothing else from the dossier header.

> **TO JONATHAN, STEPHANIE E., JASON W., AMY M., SHADOW, AND SCOUT**

I kept rereading the word kind because I wanted to know whether a trait still belonged
to me if somebody wrote it first. I have an answer now. A trait becomes yours in the choosing.
Jonathan could write KIND one thousand times and it would mean nothing if I stopped choosing it
when choosing it cost something. Keep the word. Just remember it is a verb disguised as an adjective.

The Character Bible describes Redsky through a role—**classy, kind, silly recurring participant**—and a
trait structure that includes classy , kind , silly , poised , playful , observant , generous , creative , competitive , gracious.

The letter does not reject those descriptions.

It rejects their sufficiency.

One line in the writer-facing material says that Redsky wants to **have fun without trading kindness for edge**.
Another says they need to **let himself be ridiculous without embarrassment**.
